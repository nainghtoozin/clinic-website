<x-auth-layout>
    <x-page-header title="Create Invoice" subtitle="{{ $consultation ? 'For consultation #' . $consultation->id : 'Bill a patient' }}"
        :breadcrumbs="[['label' => 'Invoices', 'url' => route('invoices.index')], ['label' => 'Create Invoice']]">
        ...
        <div class="row g-4">
            <div class="col-lg-8">
                ...
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-body">
                        @if ($medicines->isEmpty() && $services->isEmpty())
                            <div class="text-center text-muted py-4">
                                <i class="bi bi-info-circle fs-3 d-block mb-2"></i>
                                <small>Add medicines or services to the formulary before billing.</small>
                            </div>
                        @endif
                ...
                <div class="card shadow-sm border-0 mb-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="number" name="discount" id="discount-input" class="form-control @error('discount') is-invalid @enderror" step="0.01" min="0" value="{{ old('discount', '0.00') }}">
                            @error('discount')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="number" name="tax" id="tax-input" class="form-control @error('tax') is-invalid @enderror" step="0.01" min="0" value="{{ old('tax', '0.00') }}">
                            @error('tax')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="d-flex justify-content-between mb-2">
                            ...
                            <span id="preview-discount" class="text-success">-$0.00</span>
                        </div>
                        <div class="d-flex justify-content-between mb-2">
                            <span class="text-muted">Tax</span>
                            <span id="preview-tax" class="text-danger">+$0.00</span>
                        </div>
                        <div class="d-flex justify-content-between mb-3">
                            <span class="fw-bold">Total</span>
                            <span id="preview-total" class="fw-bold fs-5">$0.00</span>
                        </div>
                        <small class="text-muted d-block mb-3"><i class="bi bi-info-circle me-1"></i>Final totals are calculated and stored by the server on save.</small>
                        <div class="d-grid">
