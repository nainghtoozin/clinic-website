            ...
            <div class="row gy-5">
                ...
                <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="200">
                    <div class="service-image">
                        <img src="{{ $service->imageUrl() }}" alt="{{ $service->title }}" class="img-fluid">
                ...
                <div class="col-lg-6" data-aos="fade-left" data-aos-delay="300">
                    <div class="service-content">
                        <h2>{{ $service->title }}</h2>
                        <p class="service-tagline"> <b>Price : $</b> {{ $service->price }} </p>
            ...
            <div class="row mt-5">
                ...
                <div class="col-lg-8" data-aos="fade-right" data-aos-delay="100">
                    <div class="booking-section">
                        ...
                        <p>Our cardiology specialists are available for consultations Monday through Friday. Same-day
                            appointments
                            available for urgent cases.</p>
